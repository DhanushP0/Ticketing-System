...
<head>
  ...
  <style>
    ...
    .dark-mode-active .dark-mode-toggle:before {
      ...
      <div class="px-3 py-4">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item has-submenu">
            ...
            <ul class="submenu">
              <li class="nav-item">
                <a href="<?= base_url('admin/ticket') ?>" class="nav-link <?= uri_string() == 'admin/ticket' ? 'active' : '' ?>">
                  <span>All Tickets</span>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url('admin/ticket/open') ?>" class="nav-link <?= uri_string() == 'admin/ticket/open' ? 'active' : '' ?>">
                  <span>Open Tickets</span>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url('admin/ticket/closed') ?>" class="nav-link <?= uri_string() == 'admin/ticket/closed' ? 'active' : '' ?>">
          ...
          <li class="nav-item">
            <a href="<?= base_url('admin/settings') ?>" class="nav-link <?= uri_string() == 'admin/settings' ? 'active' : '' ?>">
    ...
    <div class="content" id="content">
      ...
      <nav class="topbar navbar navbar-expand navbar-light bg-white">
        <div class="container-fluid">
          ...
          <div class="search-form ms-3 d-none d-md-block">
            <input type="text" class="form-control" placeholder="Search...">
            <i class="fas fa-search"></i>
          </div>
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <div class="topbar-divider d-none d-sm-block" style="width: 0; border-right: 1px solid #e3e6f0; height: 2rem; margin: auto 0.5rem;"></div>
